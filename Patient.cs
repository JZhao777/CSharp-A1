...
namespace Csharp_Assignment1
{
    ...
    {
        //create 4 properties using shorthand getter and setters
        public string FirstName { get; set; }
        public string LastName { get; set; }
        public double Weight { get; set; }
        public double Height { get; set; }

        //Create a custom constructor that accepts the first name, last name, weight, and height 
        ...
        //Create a public method CalculateBloodPressure to calculate the blood pressure of the patient:
        public string CalculateBloodPressure(int systolic, int diastolic)
        {
            //create an empty string called bloodPressureResult to assign value later
